...
(function (AlpakaShop) {
    let artikelArray = [
        ...
        { name: "Al Pacone", preis: 800, bezeichnung: "männlich, ist edler Herkunft", bild: "Weiß-SchwarzAlpaka.jpg", kategorie: "alpaka" },
        ...
        { name: "Leckstein", preis: 7, bezeichnung: "Leckstein für Alpakas, Pferde, etc.", bild: "Zubehör/Leckstein.jpg", kategorie: "zubehör" },
        ...
        { name: "Schafschere", preis: 20, bezeichnung: "aus purem Stahl, gut um Schafe und Alpakas zu scheren.", bild: "Zubehör/schere.jpg", kategorie: "zubehör" },
        ...
        { name: "Alpaka Sticker", preis: 10, bezeichnung: "14 Stück", bild: "Zubehör/AlpakaSticker.jpg", kategorie: "zubehör" },
    ...
    for (let index = 0; index < artikelArray.length; index++) {
        if (artikelArray[index].kategorie == "alpaka") {
            console.log(artikelArray[index].name);
            let newDiv = document.createElement("div");
            newDiv.classList.add("produkt");
            newDiv.innerHTML = artikelArray[index].name;
            document.querySelector("#Alpakas")?.appendChild(newDiv);
            let newImg = document.createElement("img");
            newImg.setAttribute("src", "artikelArray[index].bild");
